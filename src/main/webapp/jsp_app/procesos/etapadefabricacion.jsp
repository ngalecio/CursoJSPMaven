...
<html class="no-js" lang="en">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6>Tecnica de Fabricacion</h6>
                                    <br>

                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="txtCodigoTF">CODIGO TF</label>
                                                <div class="input-group">
                                                    <input type="text" id="txtCodigoTF" name="txtCodigoTF" class="form-control form-control-sm" placeholder="CODIGOTF">
                                                    <span class="input-group-btn">
                                                        <button type="button" class="btn btn-secondary btn-xs mr-3" id="btnBuscarTF">
                                                            <i class="fa fa-search" aria-hidden="true"></i>
                                                            Buscar
                                                        </button>
                                                    </span></div>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="txtNombreTF">NOMBRE TF</label>
                                                <div class="input-group">
                                                    <input type="text" id="txtNombreTF" name="txtNombreTF" class="form-control form-control-sm" placeholder="CODIGOTF">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="txtDescripcionTF">DESCRIPCION TF</label>
                                                <div class="input-group">
                                                    <input type="text" id="txtDescripcionTF" name="txtDescripcionTF" class="form-control form-control-sm" placeholder="DECRIPCION TF">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="txtTiempoTF">Tiempo TF</label>
                                                <div class="input-group">
                                                    <input type="text" id="txtTiempoTF" name="txtTiempoTF" class="form-control form-control-sm" placeholder="CANTIDAD">
                                                    <span class="input-group-btn">
                                                        <button type="button" class="btn btn-success btn-xs mr-3" id="btnAgregarTF">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                    <div class="col-10">
                                        <h5>Detalle de Etapa</h5>    
                                    </div>   
                                    <div class="col-2">
                                    <button type="button" class="btn btn-success btn-xs mr-3" id="btnGrabarEtapa">
    ...
    <script src="<%out.print(getServletContext().getContextPath());%>/js_app/app/etapadefabricacion.js"></script>
</body>
