                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-bordered" id="id_tabla_producto">
                                                    ...
                                                    <tbody id="tbodyProducto">
                                                        <% while (it.hasNext()) {
                                                                Producto cat = it.next();

                                                        %>
                                                        <tr codigoProducto="<%=cat.getCodigo()%>" 
                                                            nombreProducto="<%=cat.getNombre()%>" 
                                                            descripcionProducto="<%=cat.getDescripcion()%>" 
                                                            lote="<%=cat.getLote()%>" 
                                                            codigocategoria="<%=cat.getCodigo_categoria()%>" 
                                                            codigopresentacion="<%=cat.getCodigo_presentacion()%>"                                                                                
                                                            fotobase64="<%=cat.getFoto_base64()%>"    
                                                            style="height:20px">
                                                            <td><%= cat.getCodigo()%></td>    
                                                            ...
                                                            <td><%= cat.getNombre_presentacion()%></td>    
                                                            <td>
                                                                <img id="foto" src="data:image/gif;base64,<%= cat.getFoto_base64()%> "
                                                            ...
                                                            <td class="text-center">
                                                                <button class='btn btn-warning btn-xs editar-Producto'><i class='fa fa-edit'></i>Editar</button>
                                                                <button class='btn btn-danger btn-xs eliminar-Producto'><i class='fa fa-trash'></i>Eliminar</button>
                    ...
                    <div class="modal-content">
                        <form id="FrmProductoModal">
                            ...
                            <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="file-loading">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="id_foto" aria-describedby="inputGroupFileAddon01"
                                ...
                                <input type="hidden" id="textobase64" name="textobase64" value="">
