...
public class CategoriaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer id_categoria = Integer.parseInt(request.getParameter("id_categoria").toString());
        ...
        switch (action) {
            case "addCategoria":                
                cat.setCodigo(0);
                cat.setNombre(nombre_categoria);
                CategoriaDAO.Registrar(cat);
...
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet CategoriaController at " + request.getContextPath() + jsonResponse+"</h1>");
//            out.println("</body>");
//            out.println("</html>");
        //}
